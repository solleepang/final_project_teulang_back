...
urlpatterns = [
    ...
    path('kakao/user/', views.KaKaoUserView.as_view(), name='kakao_signup_view'),
    path('kakao/login/', views.KakaoLoginView.as_view(), name="kakao_login_view"),
    path('kakao/login/callback/', views.KakaoCallbackView.as_view(), name='kakao_callback_view'),
